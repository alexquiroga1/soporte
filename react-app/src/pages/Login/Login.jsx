    ...
    async () => {
      ...
      if (!cleanEmail) {
        sileo.warning({
          ...
          description:
            "Primero escribí tu correo electrónico y después seleccioná recuperar contraseña.",
        });
      ...
      try {
        ...
        sileo.success({
          ...
          description:
            "Si existe una cuenta asociada a ese correo, vas a recibir las instrucciones para restablecer la contraseña.",
        });
      } catch (error) {
        console.error(
        ...
        switch (
          ...
          case "auth/too-many-requests":
            message =
              "Se realizaron demasiados intentos. Esperá unos minutos.";
            break;
