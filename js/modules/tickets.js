  ...
  win.document.write(`
    ...
    <body>
      ...
      <div class="legal">
        ...
        El cliente declara que los datos del equipo son correctos.

        ${negNombre}

        no se responsabiliza por fallas ocultas no declaradas
        al momento del ingreso, ni por la pérdida de datos.

        Todo equipo abandonado por más de 90 días será
                      ...
                      t => `
                        ...
                        >
                          ...
                          <div class="kc-top">
                            ...
                            <div
                              class="prio ${(t.prioridad || 'P2').toLowerCase()}"
                            >
                              ${t.prioridad || 'P2'}
                            </div>
...
export function openTicketModal(id){
  ...
  /*
     Activa el modo visual especial
     para Detalle Ticket.
  */
  ...
  */
  ...
  if(
      ...
      if(
          ...
          efHtml +=
              '<span class="badge" style="background:#f0f0f0; color:#333;">Pantalla</span>';
      ...
      if(
          ...
          efHtml +=
              '<span class="badge" style="background:#f0f0f0; color:#333;">Carcasa</span>';
      ...
      if(
          ...
          efHtml +=
              '<span class="badge" style="background:#f0f0f0; color:#333;">Teclado</span>';
      ...
      if(
          ...
          efHtml +=
              '<span class="badge" style="background:#f0f0f0; color:#333;">Cargador</span>';
      ...
      if(
          ...
          efHtml +=
              '<span class="badge" style="background:#f0f0f0; color:#333;">Batería</span>';
      ...
      if(
          ...
          efHtml +=
              '<span class="badge" style="background:#f0f0f0; color:#333;">Puertos</span>';

      }

      efContainer.innerHTML =
          efHtml ||
          '<span style="font-size:11px; color:var(--muted);">Sin detalles OK</span>';
  ...
  */
  ...
  if(
      ...
      if(
          ...
          accHtml +=
              '<span class="badge" style="background:#e3f2fd; color:#0d47a1;">🔌 Cargador</span>';
      ...
      if(
          ...
          accHtml +=
              '<span class="badge" style="background:#e3f2fd; color:#0d47a1;">💼 Funda</span>';
      ...
      if(
          ...
          accHtml +=
              '<span class="badge" style="background:#e3f2fd; color:#0d47a1;">🪢 Cable</span>';

      }

      accContainer.innerHTML =
          accHtml ||
          '<span style="font-size:11px; color:var(--muted);">Ninguno</span>';
  ...
  */
  ...
  setText(
      ...
      `Ticket en fase: ${
        stage.label || t.stage
      }. Los cambios operativos quedan registrados en la bitácora.`
  );
...
export async function fijarPresupuesto(){
  ...
  if(!input){
      ...
      toast(
          'No se encontró el campo de presupuesto.'
      );
...
export async function desbloquearPresupuesto(){
  ...
  try {
      ...
      await logTicketEvent(
          currentTicketId,
          'Presupuesto editado',
          'Se habilitó la modificación del monto'
      );

  } catch(e) {

      console.error(
          'Error al desbloquear presupuesto:',
          e
      );
...
export function sendWhatsAppNotice(){
  ...
  const msg =
      `Hola ${t.cliente}, te escribimos de *${empresa}*.\n\n` +
      `Te informamos que tu equipo *${t.equipo}* ` +
      `(Ticket #${t.id}) se encuentra actualmente ` +
      `en estado: *${estadoStr}*.\n\n` +
...
export async function saveDiagnostico(){
  ...
  if(
      ...
      toast(
          'No se pudo localizar el diagnóstico.'
      );
...
export function populateRepuestosSelect(){
  ...
  if(
      ...
      sel.innerHTML =
          '<option value="">(Catálogo vacío)</option>';
      ...
      `
        <tr>
          ...
          <td
            ...
            "
          >
            Sin repuestos ni servicios cargados.
          </td>
...
export async function updatePiezaPrice(
  ...
  try {
      ...
      await logTicketEvent(
          currentTicketId,
          'Costo modificado',
          `El precio de "${nuevasPiezas[idx].nombre}" se ajustó a ${fmt(val)}`
      );
...
export async function addPiezaToTicket(){
  ...
  if(!sel){
      ...
      toast(
          'Selector de repuestos no encontrado.'
      );
...
export async function enviarAFacturacion(){
  ...
  if(total <= 0){
      ...
      alert(
          'ATENCIÓN: Debes agregar al menos un repuesto o servicio antes de enviarlo a Caja.'
      );
  ...
  if(yaExiste){
      ...
      alert(
          'Este ticket ya fue enviado a facturación previamente.'
      );
...
export async function eliminarTicketConCodigo(){
    ...
    if(
        ...
        const confirmacion =
            confirm(
                "⚠️ ¿Estás 100% seguro? Esta acción borrará el ticket para siempre y no se puede deshacer."
            );
